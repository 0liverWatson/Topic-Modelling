            ...
            for j in range (0,len(Window_5_Min_Entities)):
                if(i>=j):
                    ...
                    if(Ith_DataFrame_length<Jth_DataFrame_length):
                        ...
                        if(Entity_Counter > (Ith_DataFrame_length /100)*N):
                        ...
                        if(Entity_Counter > (Jth_DataFrame_length /100)*N):
                            printval = list_of_Entity_Nodes[i]
                            while printval.nextval is not None:
                                if(printval.index == j):
                                    Check_Node = True
            ...
            for j in range (0,len(Window_5_Min_hashtag)):
                if(i>=j):
                    ...
                    if(Ith_length<Jth_length):
                        if(Intersection>=(len(Window_5_Min_hashtag[i][1])/100)*M):
                         ...
                         if(Intersection>=(len(Window_5_Min_hashtag[j][1])/100)*M):
